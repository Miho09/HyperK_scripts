...
void qraw_yaxis(char *filename=NULL) {
  ...
  TH2F *Qraw_y = new TH2F("Qraw_y","Raw Charge vs Y axis",100,70,80,1000,-4000,4000);

  // TH2D *discorr = new TH3D("coorq", "Cartesian coordinates with charge",100,-4000,4000,100,-4000,4000,1000,-4000,4000);
  // cout << "1" << endl;
  Qraw_y->SetTitle("Charge Distribution");
  // cout << "2" << endl;
